  ...
  overrides: [
    {
      files: [
        'pkg/apps/app.js',
        'pkg/process-manager/index.js',
        'pkg/process-manager/test/index.test.js',
        'pkg/redis-client/index.js',
      ],
      rules: {
        'no-process-env': 0,
      },
    ...
    },
    {
      files: [
        'pkg/apps/app.js',
        'pkg/eslint-config/test/validate.test.js',
      ],
      rules: {
        'no-sync': 0,
      },
    ...
    {
      excludedFiles: ['jest.config.unit.js'],
      files: '*/**/test/**/*.js',
      rules: {
